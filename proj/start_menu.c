...
void start_menu_init(){
	...
	button* singleplayer = create_button(400, 200, 200, 90, &start_menu_singleplayer_on_click, 2);
	menu_add_button(start_menu, singleplayer);
	button* multiplayer = create_button(400, 300, 200, 90, &start_menu_multiplayer_on_click, 2);
	menu_add_button(start_menu, multiplayer);
	button* highscore = create_button(400, 400, 200, 90, &start_menu_highscore_on_click, 2);
	menu_add_button(start_menu, highscore);
	button* options = create_button(400, 500, 200, 90, &start_menu_options_on_click, 2);
	menu_add_button(start_menu, options);
	button* exit = create_button(400, 600, 200, 90, &start_menu_exit_on_click, 2);
