...
//Break Codes
#define ESC_BREAKCODE 			ESC_MAKECODE & BIT(7)
#define UP_ARROW_BREAKCODE 		UP_ARROW_MAKECODE & BIT(7)
#define DOWN_ARROW_BREAKCODE 	DOWN_ARROW_MAKECODE & BIT(7)
#define RIGHT_ARROW_BREAKCODE 	RIGHT_ARROW_MAKECODE & BIT(7)
#define LEFT_ARROW_BREAKCODE 	LEFT_ARROW_MAKECODE & BIT(7)
#define SPACE_BREAKCODE 		SPACE_MAKECODE & BIT(7)
#define ENTER_BREAKCODE 		ENTER_MAKECODE & BIT(7)
#define A_BREAKCODE 			A_MAKECODE & BIT(7)
#define D_BREAKCODE				D_MAKECODE & BIT(7)
#define W_BREAKCODE				W_MAKECODE & BIT(7)
